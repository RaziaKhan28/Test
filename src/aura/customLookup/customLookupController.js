  ...
  // This function call when the end User Select any record from the result list.   
    ...
    // get the selected Contact record from the COMPONETN event 
       ...
       component.set("v.selectedRecordId" , selectedContactId); 
        console.log('selectedRecordId11 is' +  component.get("v.selectedRecordId" ));
    ...
    handleSaveContact: function(component,event){
        ...
        saveContactAction.setParams({
            "selectedObjectId": contactId,
            "recordId": oppRecordId
          });
       // console.log("Selected Contact ID:" + selectedObjectId);
       // console.log("Selected Opp ID: " + recordId);
